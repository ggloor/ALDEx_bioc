...
setGeneric("aldex.clr", function(reads, conds, mc.samples=128, denom="all", verbose=FALSE, useMC=FALSE, gamma = NULL, entropy=FALSE) standardGeneric("aldex.clr"), signature=c("reads"))
