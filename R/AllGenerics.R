...
setGeneric("aldex.clr", function(reads, conds, mc.samples=128, denom="all", verbose=FALSE, useMC=FALSE, scale.samples) standardGeneric("aldex.clr"), signature=c("reads"))
