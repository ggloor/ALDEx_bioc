...
d <- c(4000, 4000, 4000, 4000, 4000, 400,400,400,400,4000,400,500,500,500,400,400,400,400,400,100,400, # Pre
       4000, 4000, 3000, 256, 4000, 400,400,400,400,4000,400,500,500,500,200,400,400,400,400,100,100) # Post
...
##Pass to ALDEx2
aldexScaleSim.fit <- aldex(countdata, as.character(rdat$Condition), scale.lambda=0.5, scale.mu =1, mc.samples = 256)
...
aldexScaleSim.fitCLR <- aldex(countdata, as.character(rdat$Condition), scale.lambda = 1e-3, mc.samples = 256)
 
sig.aldexScaleSimCLR = aldexScaleSim.fitCLR %>% filter(wi.eBH <= 0.05)
head(sig.aldexScaleSimCLR)
dim(sig.aldexScaleSimCLR)

aldexScaleSim.fitCoDA <- aldex(countdata, as.character(rdat$Condition), scale.lambda = 10, mc.samples = 256)
...
```{r getScaleSamps}
x <- aldex.clr(countdata, as.character(rdat$Condition), scale.lambda = 10, mc.samples = 256)
...
```{r senAnalysis}
x <- aldex.clr(countdata, as.character(rdat$Condition), scale.lambda = 1e-3, mc.samples = 256)
...
x.s <- aldex.clr(selex, conds, scale.lambda=1e-3)
...
x.s <- aldex.clr(selex, conds, scale.lambda=1)
x.s.e <- aldex.effect(x.s)
sig <- which(abs(x.e$effect) > 2)
sig.s <- which(abs(x.s.e$effect) > 2)
